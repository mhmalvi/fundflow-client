      ...
      <div className="max-w-[1280px] px-5 mx-auto pt-10 pb-10 overflow-hidden">
        <Fade direction="right" triggerOnce>
          <div className="text-xl lg:text-4xl font-semibold mb-2">
            {lang === "eng"
              ...
              : `তোমার যা আছে তাই করো`}
          </div>
          <div className="flex italic text-xs lg:text-sm">
            <span>
              {lang === "eng" ? `January 15, 2023` : `১৫ জানুয়ারি, ২০২৩`}
            </span>{" "}
            &nbsp; / &nbsp;
        ...
        <Fade>
          {lang === "eng" ? (
            <div className="lg:text-xl">
              ...
              the layout and draw attention to key parts of your content. This
              page is a demo that shows everything you can do inside portfolio
              and blog posts. We've included everything you need to create
              engaging posts about your work, and show off your case studies in
              a beautiful way. Obviously, we've styled up all the basic text
              formatting options available in markdown. You can create lists:
              Simple bulleted lists Like this one Are cool And: Numbered lists
              Like this other one Are great too You can also add blockquotes,
              which are shown at a larger width to help break up the layout and
              draw attention to key parts of your content. <br /> <br />
              This page is a demo that shows everything you can do inside
              portfolio and blog posts. We've included everything you need to
              create engaging posts about your work, and show off your case
              studies in a beautiful way. Obviously, we've styled up all the
            ...
            <div className="lg:text-xl">
              ...
              পোর্টফোলিও এবং ব্লগ পোস্ট. আমরা আপনার যা প্রয়োজন তা অন্তর্ভুক্ত
              করেছি আপনার কাজ সম্পর্কে আকর্ষক পোস্ট তৈরি করুন, এবং আপনার
              ক্ষেত্রে দেখান একটি সুন্দর উপায়ে পড়াশুনা। স্পষ্টতই, আমরা সব
              স্টাইল আপ করেছি মার্কডাউনে উপলব্ধ মৌলিক পাঠ্য বিন্যাস বিকল্প। আপনি
              তৈরি করতে পারেন তালিকা: সাধারণ বুলেটযুক্ত তালিকা এইরকম একটি
              দুর্দান্ত এবং: সংখ্যাযুক্ত এই অন্য একটির মত তালিকাগুলিও দুর্দান্ত
              আপনিও যোগ করতে পারেন ব্লককোট, যা ভাঙ্গতে সাহায্য করার জন্য একটি
              বড় প্রস্থে দেখানো হয় লেআউট এবং আপনার বিষয়বস্তুর মূল অংশ মনোযোগ
              আকর্ষণ. এই পেজ হল একটি ডেমো যা দেখায় যে আপনি পোর্টফোলিও এবং
              ব্লগের ভিতরে যা করতে পারেন পোস্ট আকর্ষক তৈরি করতে আপনার যা
              প্রয়োজন তা আমরা অন্তর্ভুক্ত করেছি আপনার কাজ সম্পর্কে পোস্ট, এবং
              একটি সুন্দর আপনার কেস স্টাডি দেখান উপায় স্পষ্টতই, আমরা সমস্ত
              মৌলিক পাঠ্য বিন্যাস স্টাইল করেছি মার্কডাউনে উপলব্ধ বিকল্পগুলি।
              আপনি তালিকা তৈরি করতে পারেন: সহজ বুলেটযুক্ত এইরকম তালিকাগুলি
              দুর্দান্ত এবং: সংখ্যাযুক্ত তালিকাগুলি এই অন্যটির মতো৷ খুব ভালো
              আপনি ব্লককোটও যোগ করতে পারেন, যা a এ দেখানো হয়েছে বৃহত্তর প্রস্থ
              লেআউট ভাঙ্গতে সাহায্য করে এবং কী-এর প্রতি দৃষ্টি আকর্ষণ করে আপনার
              সামগ্রীর অংশ। <br /> <br />
              এই পৃষ্ঠাটি একটি ডেমো যা আপনি ভিতরে যা করতে পারেন তা দেখায়
              পোর্টফোলিও এবং ব্লগ পোস্ট. আমরা আপনার যা প্রয়োজন তা অন্তর্ভুক্ত
              করেছি আপনার কাজ সম্পর্কে আকর্ষক পোস্ট তৈরি করুন, এবং আপনার
        ...
        <div className="lg:text-xl mb-5">
          {lang === "eng"
            ...
            : `এখানে একটি সত্যিই ঝরঝরে কাস্টম বৈশিষ্ট্য রয়েছে যা আমরা আমাদের গ্যালারী গ্যালারিতে যোগ করেছি:`}
        </div>
        ...
        <div className="mx-auto pt-10 lg:pt-20">
          ...
          <div className="text-lg font-semibold my-5">
            {lang === "eng" ? `Leave a comment` : `মতামত দিন`}
          </div>
          <textarea
            name="comment"
            id="comment"
