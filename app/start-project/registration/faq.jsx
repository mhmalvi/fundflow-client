  ...
  return (
    <div>
      <div className="bg-white rounded-xl shadow-lg p-4 lg:p-10 my-5">
        ...
        {lang==="eng"? `Frequently Asked Questions`:`সচরাচর জিজ্ঞাসিত প্রশ্নসমূহ`}
        </div>
        ...
        *{lang==="eng"? "All fields required unless noted.":"উল্লেখ না করা পর্যন্ত সমস্ত ক্ষেত্র আবশ্যক."}
        ...
        <div className="flex flex-col">
          <input
            ...
            placeholder={lang==="eng"? "Question":`প্রশ্ন`}
          />
          <input
            type="text"
            className="lg:w-1/2 shadow-lg py-2 lg:py-4 px-2 rounded-lg outline-none mb-4 border border-gray-300 text-sm lg:text-base"
            placeholder={lang==="eng"? "Answer":`উত্তর`}
          />
        </div>
        <div className="text-lg lg:text-xl text-home-color cursor-pointer">{lang==="eng"? `Create New FAQ`:`নতুন এফএকিউ তৈরি করুন`} +</div>
      </div>
