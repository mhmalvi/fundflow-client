...
const AboutHeader = () => {
  ...
  return (
    <div className="max-w-[1280px] mx-auto mt-20 lg:mt-28 px-4 lg:px-18">
            ...
            <Fade direction="left" triggerOnce>
              <div className="font-bold text-xl lg:text-4xl pb-5">
                {lang === "eng"
                  ...
                  : "আমরা একটি মিশনে আছি যাতে আইডিয়াগুলি জীবনে আনতে পারি।"}
              </div>
                ...
                <div>
                  ...
                  <div className="text-sm lg:text-base">
                    {lang === "eng"
                      ...
                      : "একটি এন্টারপ্রাইজ তৈরি করতে আপনার হাজার হাজার প্রয়োজন নেই।"}
                  </div>
                </div>
              </div>
      ...
      <div className="text-black mx-auto py-10 lg:py-20 lg:px-12">
        {lang === "eng" ? (
          <div className="text-2xl lg:text-5xl text-center font-semibold pb-10 lg:pb-20">
            Businesses all over the world <br /> trust us to build their brand
          </div>
        ) : (
          <div className="text-2xl lg:text-5xl text-center font-semibold pb-10 lg:pb-20">
            সারা বিশ্বে ব্যবসা তাদের ব্র্যান্ড <br />
            <br /> তৈরি করতে আমাদের বিশ্বাস করুন।
          </div>
        )}
      ...
      <div className="mb-10 lg:mb-20 lg:mt-20 lg:px-12">
        <div className="flex flex-col lg:flex-row justify-between items-center overflow-hidden">
              ...
              <div className="flex items-center pb-3">
                ...
                <div className="text-sm lg:text-lg">
                  {lang === "eng"
                    ...
                    : "সোশ্যাল মিডিয়া, ব্লগ এবং মেসেঞ্জারে পোস্ট করা"}
                </div>
              </div>
              <div className="flex items-center pb-3">
                <Image src={Tick} alt="img" className="w-5 h-5 mr-5" />
      ...
      <div className="w-11/12 lg:w-auto mx-auto lg:m-0 grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-10 my-20 lg:px-12">
        <Fade>
          <div>
            ...
            <div className=" text-sm lg:text-base text-center pb-8 px-2">
              {lang === "eng"
                ...
                : "একটি এন্টারপ্রাইজ তৈরি করতে দুঃস্বপ্নের প্রয়োজন হয় না বা আপনার হাজার হাজার খরচের প্রয়োজন হয় না ফেলিক্সের উদ্দেশ্য।"}
            </div>
          </div>
        </Fade>
            ...
            <Fade direction="left" triggerOnce>
              <div className="w-full lg:w-2/3 mx-auto lg:m-0 pb-10 lg:pb-0 text-white">
                ...
                <div className="w-full mx-auto flex relative">
                  ...
                  />
                  <div className="text-white bg-home-color rounded-full absolute right-1 my-1 py-4 px-5 lg:px-10 cursor-pointer">
                ...
                <div className="w-full absolute top-[30%] px-4">
                  <div className="text-sm lg:text-lg text-white text-center pb-5">
                    {lang === "eng"
                      ...
                      : "অনুচ্ছেদ হল কাগজপত্র বিল্ডিং ব্লক"}
                  </div>
                  {lang === "eng" ? (
      ...
      <div className="w-11/12 lg:w-full mx-auto lg:m-0 grid lg:grid-cols-2 lg:gap-10 lg:px-12">
        <Fade>
