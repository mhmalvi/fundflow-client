    ...
    <div className="lg:w-full h-screen mx-auto text-white lg:py-20 lg:pl-10 px-5 lg:px-0">
      ...
      <div className="flex justify-between relative">
        <div className="lg:w-1/2">
          ...
          {lang==="eng"? "Cannot remember your password?":"আপনার পাসওয়ার্ড মনে করতে পারেন না?"}
            <span className="underline text-sky-600 px-2 cursor-pointer">
            {lang==="eng"? "Reset your password":"আপনার পাসওয়ার্ড পুনরায় সেট করুন"}
            </span>
          </div>
          <div className="inline-block bg-home-color text-white text-center rounded-md px-4 py-2 my-5">
          {lang==="eng"? "Save":"সংরক্ষণ করুন"}
          </div>
        </div>
        <a href="" className="text-sm underline text-sky-600">
          {lang==="eng"? "change":"পরিবর্তন করুন"}
