...
const EventContent = () => {
  ...
  return (
    <div className="bg-[#ececec]">
              ...
              <div className="bg-white bg-opacity-30 backdrop:filter backdrop-blur-sm lg:bg-transparent lg:backdrop-blur-none rounded-2xl p-5">
                ...
                {lang === "eng" ? (
                  ...
                  <div className="text-sm lg:text-base text-white">
                    ...
                    ঘটনাবলী হল মুদ্রণ এবং টাইপসেটিং এর ডামি টেক্সট শিল্প
                  </div>
                )}
              </div>
            </div>
      ...
      <div className="max-w-[1280px] px-4 lg:px-30 mx-auto py-10 lg:py-20">
        <Fade>
          <div className="text-xl lg:text-4xl font-semibold mb-5">
            {lang === "eng"
              ? `Lorem Ipsum is simply dummy text`
              : `আমি একটি কম্পিউটার প্রোগ্রাম যা আপনাকে সহায়তা করতে পারি।`}
          </div>
          {lang === "eng" ? (
            ...
            <div className="lg:text-xl mb-10">
              আমি এখন বাংলায় লেখা একটি বাক্য লেখছি। আমার কাজ হলো মানুষদের
              সাহায্য করা এবং তাদের প্রশ্নের উত্তর দেওয়া। আমি একটি স্বচ্ছ এবং
              নিরাপদ সফটওয়্যার। আমার মূল লক্ষ্য হল মানুষকে সেবা করা। বাংলা হল
              আমার প্রিয় ভাষা। আমি এখন বাংলায় লেখা একটি বাক্য লেখছি। আমার কাজ
              হলো মানুষদের সাহায্য করা এবং তাদের প্রশ্নের উত্তর দেওয়া। আমি একটি
              স্বচ্ছ এবং নিরাপদ সফটওয়্যার। আমার মূল লক্ষ্য হল মানুষকে সেবা করা।
              বাংলা হল আমার প্রিয় ভাষা।
              <br />
              <br />
              আমি এখন বাংলায় লেখা একটি বাক্য লেখছি। আমার কাজ হলো মানুষদের
              সাহায্য করা এবং তাদের প্রশ্নের উত্তর দেওয়া। আমি একটি স্বচ্ছ এবং
